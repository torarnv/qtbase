...
#ifndef QWINRTKEYMAPPER_H
#define QWINRTKEYMAPPER_H
...
{
    Q_DISABLE_COPY(QWinRTKeyMapper)
public:
    explicit QWinRTKeyMapper();
    ~QWinRTKeyMapper();

    bool translateKeyEvent(QWindow *widget, ABI::Windows::UI::Core::IKeyEventArgs *args);
...
private:
    bool translateKeyEventInternal(QWindow *receiver, ABI::Windows::UI::Core::IKeyEventArgs *args, bool grab);
    void updateKeyMap(ABI::Windows::UI::Core::IKeyEventArgs *args);
    ...
    unsigned char m_keyboardBuffer[256];
};
